...
<head>
	<meta charset="UTF-8" />
	<title>Cadastro de Funcionário | Sistema de reservas</title>
	<link href="../estilos/funcionario-estilo.css" rel="stylesheet"/>
...
<ul>
<li><h2>Cadastro Funcionário</h2></li>
...
<li><input type="text" name="endereco" class="padrao" placeholder="Endereço" title="Endereço" required></li>
...
<li><input type="text" name="cargo" class="padrao" placeholder="Cargo" title="Cargo" required></li>
<li>
...
<li><input type="password" name="senha" class="padrao" placeholder="Senha" title="Senha" required></li>
<li><input type="password" name="r_senha" class="padrao" placeholder="Repita a senha" title="Repita a senha" required></li>
