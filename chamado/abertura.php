...
$quarto = $cone->pdo->prepare("SELECT * FROM tipoquartos order by nomequarto");
$quarto->execute();
echo'<option value="">Quartos</option>';
...
<li><input type="text" name="periodo" value="" id="periodo" class="padrao" title="Período" required></li>
<input type="hidden" name="dia" value="" class="padrao" title="dia" id="dia">
<li><input type="text" name="horarioinicial" value="13:00" class="padrao" title="horarioinicial" placeholder="horarioinicial" required></li>
...
<li><input type="text" name="numreserva" class="padrao" title="numreserva" placeholder="numreserva" required></li>
<li><input type="text" name="horariofinal" class="padrao" title="horariofinal" value="12:00" placeholder="horariofinal" required></li>
