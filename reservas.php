...
$consulta_cliente = $cone->pdo->prepare("SELECT * FROM reservas where funcionariochave = :id order by id limit $pagina, $itens_por_pagina");
...
<td>'.$cone->converteDataPT($lista["diasaida"]).' '.$lista["horariofinal"].'</td>';
